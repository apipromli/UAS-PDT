...
class Auth extends CI_Controller
{
    ...
    private function register_()
    {
        ...
        if ($validasi == $this->session->userdata('key')) {
            ...
            $prefix = $this->db->get('tbl_sekolah')->row()->prefix;
            

            $this->db->select('RIGHT(tbl_registrasi.nomor_daftar,4) as kode', FALSE);
    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($data['sekolah']['bt'] == '0' || $data['sekolah']['bt'] == '5') {
                # code...
                redirect('','refresh');
            }
